        ...
        items={[
          {
            ...
            body: 'Free, Pro and Team are listed with what each includes, before you create an account. No per-channel upsells, no seat taxes on Team, and annual billing that simply knocks two months off. Changes to prices reach existing subscribers before they take effect.',
            points: [
