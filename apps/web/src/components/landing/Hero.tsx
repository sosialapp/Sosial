...
const FLOATERS: {
  ...
  { key: 'instagram', pos: 'left-[3%] top-[12%]', show: 'hidden sm:block', box: 'h-20 w-20', icon: 'h-9 w-9', delay: '0s', dur: '5s', depth: 34 },
  { key: 'x', pos: 'left-[21%] top-[4%]', show: 'hidden md:block', box: 'h-16 w-16', icon: 'h-7 w-7', delay: '0.8s', dur: '6s', depth: 20 },
  { key: 'youtube', pos: 'left-[2%] top-[31%]', show: 'hidden sm:block', box: 'h-20 w-20', icon: 'h-9 w-9', delay: '1.6s', dur: '5.4s', depth: 26 },
  ...
  { key: 'bluesky', pos: 'right-[4%] top-[6%]', show: 'hidden sm:block', box: 'h-20 w-20', icon: 'h-9 w-9', delay: '1.1s', dur: '5.2s', depth: 34 },
  { key: 'pinterest', pos: 'right-[2%] top-[23%]', show: 'hidden md:block', box: 'h-16 w-16', icon: 'h-7 w-7', delay: '2.8s', dur: '6.4s', depth: 20 },
