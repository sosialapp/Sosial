...
const ICON_PATHS: Record<string, React.ReactNode> = {
  ...
  'x-comment': <g transform="translate(12 0) scale(1.15 1) translate(-12 0)"><path d="M12 2C7.04 2 3 6.04 3 11c0 4.96 4.04 9 9 9v3.09l1.54-.99c2.23-1.43 6.31-4.53 7.26-9.22.13-.6.2-1.23.2-1.88 0-4.96-4.04-9-9-9zm0 2c3.88 0 7 3.12 7 7 0 .5-.06.99-.16 1.47v.01l-.01.01c-.6 2.95-2.87 5.13-4.84 6.65L14 17.8l-1.13.14c-.3.04-.59.06-.87.06-3.88 0-7-3.12-7-7 0-3.88 3.12-7 7-7z" /></g>,
